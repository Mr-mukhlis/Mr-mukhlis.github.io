				...
				<div class="row">
					<div class="col-md-12">
						<div class="colorlib-navbar-brand">
							<a class="colorlib-logo" href="index.html"><span>Mukhlis FR</span><span></span></a>
						</div>
				...
				<div class="row">
					<div class="col-md-5 animate-box">
						<div class="owl-carousel3">
							...
							<div class="item">
								<img class="img-responsive about-img" src="images/3.jpg" alt="html5 bootstrap template by colorlib.com">
							</div>
						</div>
					</div>
					<div class="col-md-6 col-md-push-1 animate-box">
						<div class="about-desc">
							<div class="owl-carousel3">
								<div class="item">
									<h2><span>My Name Is</span><span>Mukhlis FR</span></h2>
								</div>
								<div class="item">
							...
							<div class="desc">
								...
								<p class="colorlib-social-icons">
									<a href="https://www.facebook.com/profile.php?id=100050146162755&__cft__[0]=AZVC2sfWMWH85ng45EGuDMRAzUZML7be5rUr9vwv8QIqaaFIQr-mIwGZRot7abHinY1Yly5p43TxG0wvm_nOVLEKnXlHEWfKf8mF6L7Q6RhZQRNOQ5VofYr-5lPPNN6NCJZpU5RPyhwcHsRKMGUi3Rz9kIWc4w0rS-93TrgQJ-cpaw&__tn__=-UC%2CP-R" target="_blank" ><i class="icon-facebook4"></i></a>
									<a href="https://www.instagram.com/rama.dhanial/#" target="_blank" ><i class="icon-instagram"></i></a>
									<a href="#"><i class="icon-googleplus"></i></a>
									<a href="#"><i class="icon-dribbble2"></i></a>
								</p>
								<?php  echo	$output?>
								<p><a href="https://wa.me/<?php echo $no_wa?>?text=hai Kak saya ingin ....." target="_blank" class="btn btn-primary btn-outline">Contact Me with Whatsapp!</a></p>
							</div>
						</div>
					</div>
				</div>
							...
							<div class="one-third">
								...
								<div class="row">
									...
									<div class="col-md-6">
										...
										<div class="services animate-box">
											<h3>4 - Microsoft Office</h3>
											<ul>
												<li>Microsoft Word</li>
												<li>Microsoft Exel</li>
												<li>Microsoft Power Point</li>
												<li>Microsoft Acsess</li>
											</ul>
										</div>
									</div>
								</div>
							</div>
							<div class="one-forth services-img" style="background-image: url(images/komputer.jpg);">
							</div>
						</div>
					</div>
				</div>
						...
						<div class="row">
							<div class="col-md-4 animate-box">
								...
								<ul class="contact-info">
									<li><span><i class="icon-map5"></i></span>Street Patemon Gg.Dewi Shnta Muncar - Banyuwangi, 68472</li>
									<li><span><i class="icon-phone4"></i></span>082331769421</li>
									<li><span><i class="icon-envelope2"></i></span><a href="https://mail.google.com/mail/" target="_blank">mukhlisfitroh@gmail.com</a></li>
									<li><span><i class="icon-globe3"></i></span><a href="https://tulisandakwahalislami.blogspot.com/" target="_blank">tulisandakwahislmai.blogspot.com</a></li>
								</ul>
							</div>
							<div class="col-md-7 col-md-push-1 animate-box">
								<div class="row">
									...
									<form action="send.php" method="post" target="_blank">
										<div class="form-group">
											<textarea for="message" name="message" class="form-control" id="" cols="30" rows="7" placeholder="Message"></textarea>
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group">
						...
						<div class="col-md-4 col-pb-sm">
							<div class="row">
								<div class="col-md-10">
									...
									<p><a href="https://mail.google.com/mail/" >mukhlisfitroh@gmail.com</a></p>
									<p class="colorlib-social-icons">
										<a href="https://www.facebook.com/people/Mukhlis-Al-Ayyubi/pfbid022uLjKPTsqGuQSjJ7oQHwNq2F1gGHF4Ruh5uyRsruZSLFGdTyXg3XvyArWWDmFPrTl/"><i class="icon-facebook4"></i></a>
										<a href="https://www.instagram.com/rama.dhanial/#"><i class="icon-instagram2"></i></a>
										<a href="#"><i class="icon-googleplus"></i></a>
										<a href="#"><i class="icon-dribbble2"></i></a>
									</p>
								</div>
